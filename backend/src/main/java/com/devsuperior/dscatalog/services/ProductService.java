...
public class ProductService {
	...
	public Page<ProductDTO> findAllPaged(Long categoryId, String name, PageRequest pageRequest){
		List<Category> categories = (categoryId == 0) ? null : Arrays.asList(categoriaRepository.getOne(categoryId));
	...
	private void copyDtoToEntity(ProductDTO dto, Product entity) {
		...
		for (CategoryDTO categoriaDTO : dto.getCategories()) {
			Category category = categoriaRepository.getOne(categoriaDTO.getId());
